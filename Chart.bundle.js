...
module.exports = function(Chart) {
	...
	/**
	* Juan Ramos - 2017
	* This function was modify to receive a img src a draw a image into the point labels
	* 	- for a specific text a switch operator associates a label title with a image
	*	- a offset position is calculated for image position(x and y) regarding the image width and height
	*	the offset assumes that the image is a square figure
	*/
	var offset_position_x = img_width / 2;
	var offset_position_y = img_height / 2;
	...
	function fillText(ctx, text, position, fontSize) {
		if (helpers.isArray(text)) {
			...
			switch(text) {
				case "A1":
					image.src = img_src_1;
					var offset_position_y2 = offset_position_y + 10;
					var offset_position_x2 = offset_position_x;
					break;
				case "C" :
					image.src = img_src_2;
					var offset_position_y2 = offset_position_y + 5;
					var offset_position_x2 = offset_position_x;
					break;
				case "E1":
					image.src = img_src_3;
					var offset_position_y2 = offset_position_y;
					var offset_position_x2 = offset_position_x - 15;
					break;
				case "A2":
					image.src = img_src_4;
					var offset_position_y2 = offset_position_y;
			...
			ctx.drawImage(image, position.x - offset_position_x2, position.y - offset_position_y2, img_width, img_height);
		}
	}
